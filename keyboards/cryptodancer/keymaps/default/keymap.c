...
float DIRS_SONG[][2] = SONG(DIRS_SOUND);
#endif /* AUDIO_ENABLE */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERT] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                        KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                 KC_PGUP, XXXXXXX, KC_HOME, KC_LALT, KC_SPC,  KC_LGUI, KC_CAPS, L_MOUSE, KC_RALT, KC_ENT,  L_RAISE, KC_END,  XXXXXXX, KC_PGDN
    ),

    [_RAISE] = LAYOUT(
                 KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                                       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX, KC_F11,  KC_F12,  KC_DEL,
        _______, KC_ESC,  XXXXXXX, KC_LBRC, KC_MINS, KC_GRV,                                      KC_QUOT, KC_EQL,  KC_RBRC, KC_BSLS, XXXXXXX, _______,
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
                 XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, _______, XXXXXXX, XXXXXXX, _______, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [_MOUSE] = LAYOUT(
        ...
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
                 XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, _______, XXXXXXX, L_QWERT, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
};
...
bool process_record_keyncoder(uint16_t keycode, keyrecord_t *record) {
    ...
    uint8_t times = 1;
    if (delta < KEYNCODER_THRESHOLD_X2) {
        times = 2;
